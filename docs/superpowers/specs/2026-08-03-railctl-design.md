...
railctl power on                                # energises AND holds: nothing can move yet
railctl power resume                            # the release; watch the track when you run it
